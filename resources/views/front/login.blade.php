            ...
            <div class="tab-content">
                <div class="tab-pane fade active in" id="employee">
                    ...
                    <div class="forget-password">
                        ...
                        <p>
                           {{__('front.noWorriesClick')}} <a style="color:#F44336" href="javascript:;" id="forget-password">
                                {{__('front.here')}} </a>
                ...
                <div class="tab-pane fade" id="manager">
                    ...
                    <div class="forget-password">
                        <h4>{{__('front.ForgotYourPassword')}}</h4>
                        <p>
                            {{__('front.noWorriesClick')}} <a style="color:#F44336" href="javascript:;" id="forget-password-admin">
                                {{__('front.here')}} </a>
                            {{__('front.ToResetYourPassword')}}
                        </p>
                    </div>
